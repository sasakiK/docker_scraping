...
if __name__ == '__main__':
    ...
    try:
        ...
        # for article_num in range(179,183):
            # 404 Not Foundでなければ
            try:
                # get page contents
                ...
                if ((re.search("【あわせて読みたい】", contents.text) or (re.search("あわせて読みたい", contents.text))) and re.search("※", contents.text)):
                    contain = 1
                    elems = driver.find_elements_by_xpath('//*[@id="js-container"]/div/div[4]/div[1]/article/p[last()]//a[@href]')
        ...
        # save as csv file
        article_contents.to_csv("output/filmaga_contents_lastlink.csv")
